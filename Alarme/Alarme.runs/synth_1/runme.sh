...
HD_PWD='C:/Users/dylan_000/Desktop/ENSEA/Projet/Alarme/Alarme.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Cerberus.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Cerberus.tcl
