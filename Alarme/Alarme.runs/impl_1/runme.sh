...
HD_PWD='C:/Users/dylan_000/Desktop/ENSEA/Projet/Alarme/Alarme.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Cerberus.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Cerberus.tcl -notrace
